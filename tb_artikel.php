...
<table width="539" border="1" align="center" cellpadding="1" cellspacing="0" color="#000" bgcolor="#fff">
              <tr>
				...
				<td width="264"><div align="center"><strong>Title</strong></div></td>
                <td width="264"><div align="center"><strong>Date Pub</strong></div></td>
...
?>
              <tr>
				...
				<td bgcolor="#fff"><? echo $data['title']; ?></td>
                <td bgcolor="#fff"><? echo $data['tanggalPub']; ?></td>
				<td bgcolor="#fff"><? echo $data['kdkategori']; ?></td>
				<td bgcolor="#fff"><? echo "<center><a id='sundaboy' href=javascript:sendRequest('php/delet_berita.php?id=$data[idArtikel]','center3'); title='Hapus'><img src='img/hapus.png'>  </a>" ?></td>
				<td bgcolor="#fff"><? echo "<center><a id='sundaboy' href=javascript:sendRequest('php/edit_artikel.php?id=$data[idArtikel]','center3'); style='text-decoration:none'><img src='img/button-edit.gif'></a>"; ?></td>
                <? } ?>
				<center>
							<?php
